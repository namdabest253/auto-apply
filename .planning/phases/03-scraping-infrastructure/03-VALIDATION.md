...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 03-01-01 | 01 | 1 | DISC-01 | unit | `npx vitest run src/lib/scrapers/indeed.test.ts -t "parses" --reporter=verbose` | ❌ W0 | ⬜ pending |
| 03-01-02 | 01 | 1 | DISC-02 | unit | `npx vitest run src/lib/scrapers/greenhouse.test.ts --reporter=verbose` | ❌ W0 | ⬜ pending |
| 03-01-03 | 01 | 1 | PLAT-01 | unit | `npx vitest run src/lib/scrapers/stealth.test.ts --reporter=verbose` | ❌ W0 | ⬜ pending |
| 03-02-01 | 02 | 1 | DISC-01/02 | unit | `npx vitest run src/lib/scrapers/dedup.test.ts --reporter=verbose` | ❌ W0 | ⬜ pending |
| 03-02-02 | 02 | 2 | -- | integration | `npx vitest run src/workers/scrape.worker.test.ts --reporter=verbose` | ❌ W0 | ⬜ pending |
